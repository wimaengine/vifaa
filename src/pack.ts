 ...
 *
 * #### Note
 * This operation should be analogous to packing two 32 bit
...
export function packInto64Int(low: number, high: number) {
 ...
 *
 * #### Note
 * This operation should be analogous to unpacking two 32 bit
...
export function unpackFrom64Int(value: number) {
